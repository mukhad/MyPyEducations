...
sum_by_month = [0*i for i in range(12*6)]
...
with open('elena_12_17_in.csv', "r") as f:
    ...
    for row in sr:
        ...
        j = (d.year-2012)*12 + (d.month-1)
        sum_by_month[j] += float(row[6])
...
print("============")
print(sum_by_month)
print(len(sum_by_month))

with open("sum_by_month.txt", "w") as file:
